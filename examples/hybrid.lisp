...
;;;;
;;;; The M3 milestone's second validation case (LASM-plan.md sec. 2): "A
;;;; hybrid machine (e.g. accumulator + index registers + implicit call
;;;; stack)." HYBRIDFOO below is a 6502-flavoured machine with an
