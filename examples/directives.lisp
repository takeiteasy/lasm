...
;;;; examples/modes.lisp), and .RES reserves a zero-filled scratch buffer
;;;; between the code and the table.
;;;;
...
start:  lda #10        ; A = 10
        ...
        hlt
scratch: .byte 0
padding: .res 2        ; two zero-filled scratch bytes, unread by this program
table:   .byte 5, 10, 15")
